...
# IMPORT MENU EDIT NAME BARU
from app.menus.edit_name import show_edit_name_menu
...
def show_package_details(api_key, tokens, package_option_code, is_enterprise, option_order = -1):
    ...
    while in_package_detail_menu:
        ...
        # Tambah opsi Ganti Nama di menu paket
        menu_table.add_row("G", "Ganti Nama Akun")
